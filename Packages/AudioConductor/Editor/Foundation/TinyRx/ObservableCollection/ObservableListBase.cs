...
namespace AudioConductor.Editor.Foundation.TinyRx.ObservableCollection
{
    ...
    {
        private readonly Subject<ListAddEvent<T>> _subjectAdd = new();
        private readonly Subject<Empty> _subjectClear = new();
        private readonly Subject<ListRemoveEvent<T>> _subjectRemove = new();
        private readonly Subject<ListReplaceEvent<T>> _subjectReplace = new();
