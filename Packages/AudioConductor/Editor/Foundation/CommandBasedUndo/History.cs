...
namespace AudioConductor.Editor.Foundation.CommandBasedUndo
{
    /// <summary>
    ...
    public sealed class History
    {
        ...
        private readonly List<HistoryCommand> _redoes = new();
        private readonly List<HistoryCommand> _undoes = new();
